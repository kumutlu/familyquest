...
Occurrences: **3585** across **287** files.
...
| `bestStreak` | 243 |
| `level` | 180 |
| `xpProgressInLevel` | 127 |
| `xpToNextLevel` | 120 |
| `gamification_summaries` | 115 |
| `gamification_events` | 111 |
| `longestStreak` | 85 |
| `behaviour_events` | 84 |
| `gamification_state` | 54 |
| `weeklyPoints` | 52 |
| `redeemReward` | 43 |
| `task_occurrences` | 33 |
