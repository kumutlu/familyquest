...
Occurrences: **3359** across **250** files.
...
| Line | Term | Operation | Source | Semantic meaning | Code |
|---|---|---|---|---|---|
| 74 | `behaviour_events` | read | families/{f}/behaviour_events | Behaviour intent log | `'families/{familyId}/behaviour_events/{behaviourEventId}',` |
