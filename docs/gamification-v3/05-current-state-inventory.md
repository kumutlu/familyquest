...
Occurrences: **3331** across **246** files.
...
| `bestStreak` | 239 |
| `level` | 176 |
| `xpProgressInLevel` | 123 |
| `xpToNextLevel` | 116 |
| `gamification_summaries` | 108 |
| `gamification_events` | 98 |
| `longestStreak` | 85 |
| `behaviour_events` | 84 |
| `weeklyPoints` | 43 |
| `redeemReward` | 42 |
| `gamification_state` | 39 |
| `task_occurrences` | 26 |
...
| Line | Term | Operation | Source | Semantic meaning | Code |
|---|---|---|---|---|---|
| 92 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `* Resolve the canonical ˋfamilies/{familyId}/gamification_eventsˋ collection.` |
| 103 | `gamification_state` | read | in-memory / derived | New V4 projection state collection | `/** Resolve the canonical ˋfamilies/{familyId}/gamification_stateˋ collection. */` |
| 113 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `* ˋfamilies/{familyId}/gamification_events/{eventId}ˋ.` |
| 142 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `* ˋfamilies/{familyId}/gamification_eventsˋ. Only events stored under the` |
| 156 | `gamification_state` | read | in-memory / derived | New V4 projection state collection | `* ˋfamilies/{familyId}/gamification_state/{memberId}ˋ` |
