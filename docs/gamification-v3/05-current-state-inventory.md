...
Occurrences: **3043** across **226** files.
...
| `bestStreak` | 227 |
| `level` | 164 |
| `xpProgressInLevel` | 112 |
| `xpToNextLevel` | 106 |
| `gamification_summaries` | 102 |
| `longestStreak` | 83 |
| `behaviour_events` | 82 |
| `gamification_events` | 70 |
| `redeemReward` | 42 |
| `weeklyPoints` | 33 |
| `task_occurrences` | 25 |
| `levelProgressForXp` | 24 |
...
|---|---|---|---|---|---|
| 463 | `behaviour_events` | calculate | families/{f}/behaviour_events | Behaviour intent log | `let eventPath = /databases/$(database)/documents/families/$(familyId)/behaviour_events/$(eventId);` |
| 652 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& diff.hasOnly(['rewardPoints', 'lastRedemptionId'])` |
| 654 | `rewardPoints` | calculate | users.rewardPoints | Spendable Reward Points balance (RP) | `&& tx.data.costPaid == (oldData.get('rewardPoints', 0) - data.get('rewardPoints', 0))` |
| 657 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.get('rewardPoints', 0) >= 0` |
| 663 | `lifetimeXP` | calculate | users.lifetimeXP | Legacy duplicate lifetime XP counter | `// Task approval mutation: DENY client rewardPoints/lifetimeXP writes.` |
| 663 | `rewardPoints` | calculate | users.rewardPoints | Spendable Reward Points balance (RP) | `// Task approval mutation: DENY client rewardPoints/lifetimeXP writes.` |
| 689 | `behaviour_events` | calculate | families/{f}/behaviour_events | Behaviour intent log | `let event = getAfter(/databases/$(database)/documents/families/$(familyId)/behaviour_events/$(eventId));` |
| 692 | `behaviour_events` | calculate | families/{f}/behaviour_events | Behaviour intent log | `&& !exists(/databases/$(database)/documents/families/$(familyId)/behaviour_events/$(eventId))` |
| 693 | `rewardPoints` | calculate | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.get('rewardPoints', 0) == oldData.get('rewardPoints', 0) + event.data.pointsDelta` |
| 696 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `&& data.diff(oldData).affectedKeys().hasOnly(['rewardPoints', 'lifetimeXP', 'lastBehaviourEventId'])` |
| 696 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.diff(oldData).affectedKeys().hasOnly(['rewardPoints', 'lifetimeXP', 'lastBehaviourEventId'])` |
| 697 | `lifetimeXP` | calculate | users.lifetimeXP | Legacy duplicate lifetime XP counter | `&& data.get('lifetimeXP', 0) == oldData.get('lifetimeXP', 0) + event.data.pointsDelta)` |
| 699 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.diff(oldData).affectedKeys().hasOnly(['rewardPoints', 'lastBehaviourEventId']))` |
| 710 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& oldUser.data.rewardPoints >= data.costPaid` |
| 711 | `rewardPoints` | calculate | users.rewardPoints | Spendable Reward Points balance (RP) | `&& user.data.rewardPoints == oldUser.data.rewardPoints - data.costPaid` |
| 858 | `behaviour_events` | calculate | families/{f}/behaviour_events | Behaviour intent log | `&& exists(/databases/$(database)/documents/families/$(familyId)/behaviour_events/$(sourceId))` |
| 859 | `behaviour_events` | calculate | families/{f}/behaviour_events | Behaviour intent log | `&& get(/databases/$(database)/documents/families/$(familyId)/behaviour_events/$(sourceId)).data.get('effectSnapshot', null) == snapshot)` |
| 879 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& inverse.schemaVersion == 1 && inverse.entityType == 'reversal'` |
| 910 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `let reversal = getAfter(/databases/$(database)/documents/families/$(familyId)/reversals/$(reversalId));` |
| 911 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `return reversal != null` |
| 914 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.sourceKind == reversal.data.sourceKind && data.sourceId == reversal.data.sourceId` |
| 915 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.actorId == authProfileId() && data.actorName == reversal.data.actorName` |
| 916 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.reason == reversal.data.reason && data.effectSnapshot == reversal.data.inverseEffectSnapshot` |
| 924 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `let reversal = getAfter(/databases/$(database)/documents/families/$(familyId)/reversals/$(reversalId));` |
| 925 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `let original = reversal == null ? {} : reversal.data.originalEffectSnapshot;` |
| 926 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `let inverse = reversal == null ? {} : reversal.data.inverseEffectSnapshot;` |
| 930 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `return reversal != null && reversal.data.actorId == authProfileId()` |
| 940 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `let reversal = getAfter(/databases/$(database)/documents/families/$(familyId)/reversals/$(data.get('reversalId', 'null')));` |
| 941 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `let original = reversal == null ? {} : reversal.data.originalEffectSnapshot;` |
| 942 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `let inverse = reversal == null ? {} : reversal.data.inverseEffectSnapshot;` |
| 945 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `return reversal != null && data.keys().hasOnly(['type', 'familyId', 'sourceKind', 'sourceId', 'reversalId', 'actorId', 'actorName', 'childId', 'amountPence', 'e` |
| 946 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.type == 'reversal' && data.familyId == familyId` |
| 947 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.sourceKind == reversal.data.sourceKind && data.sourceId == reversal.data.sourceId` |
| 948 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.actorId == authProfileId() && data.actorName == reversal.data.actorName` |
| 949 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.effectSnapshot == reversal.data.inverseEffectSnapshot && data.createdAt == request.time` |
| 957 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `let reversal = getAfter(/databases/$(database)/documents/families/$(familyId)/reversals/$(reversalId));` |
| 958 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `return reversal != null && reversal.data.actorId == authProfileId()` |
| 959 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& reversal.data.originalEffectSnapshot.get('fundId', '') == fundId` |
| 961 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `&& data.balance == oldData.balance + reversal.data.inverseEffectSnapshot.get('fundDeltaPence', 0)` |
| 967 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `let reversal = getAfter(/databases/$(database)/documents/families/$(familyId)/reversals/$(data.get('reversalId', 'null')));` |
| 968 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `return reversal != null && txId == data.reversalId + '__fund'` |
| 970 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.type == 'reversal' && data.familyId == familyId` |
| 971 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.fundId == reversal.data.originalEffectSnapshot.get('fundId', '')` |
| 972 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.amount == reversal.data.inverseEffectSnapshot.get('fundDeltaPence', 0)` |
| 973 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.sourceKind == reversal.data.sourceKind && data.sourceId == reversal.data.sourceId` |
| 974 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.actorId == authProfileId() && data.actorName == reversal.data.actorName` |
| 975 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& data.effectSnapshot == reversal.data.inverseEffectSnapshot && data.createdAt == request.time;` |
| 983 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `let reversal = getAfter(/databases/$(database)/documents/families/$(familyId)/reversals/$(reversalId));` |
| 984 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `return reversal != null && reversal.data.actorId == authProfileId()` |
| 985 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& reversal.data.originalEffectSnapshot.get('childId', '') == uid` |
| 986 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `&& 'pointsDelta' in reversal.data.originalEffectSnapshot` |
| 987 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.diff(oldData).affectedKeys().hasOnly(['rewardPoints', 'lastReversalId'])` |
| 988 | `reversal` | calculate | families/{f}/reversals | Reversal / compensation path | `&& data.get('rewardPoints', 0) == oldData.get('rewardPoints', 0) + reversal.data.inverseEffectSnapshot.get('pointsDelta', 0)` |
| 988 | `rewardPoints` | calculate | families/{f}/reversals | Spendable Reward Points balance (RP) | `&& data.get('rewardPoints', 0) == oldData.get('rewardPoints', 0) + reversal.data.inverseEffectSnapshot.get('pointsDelta', 0)` |
| 989 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.get('rewardPoints', 0) >= 0;` |
| 1035 | `currentStreak` | read | users.currentStreak | Consecutive qualifying days | `&& data.diff(resource.data).affectedKeys().hasOnly(['uid', 'joinRequestId', 'familyId', 'role', 'displayName', 'avatarUrl', 'rewardPoints', 'lifetimeXP', 'curre` |
| 1035 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `&& data.diff(resource.data).affectedKeys().hasOnly(['uid', 'joinRequestId', 'familyId', 'role', 'displayName', 'avatarUrl', 'rewardPoints', 'lifetimeXP', 'curre` |
| 1035 | `longestStreak` | read | users.longestStreak | Legacy best-streak counter on the user doc | `&& data.diff(resource.data).affectedKeys().hasOnly(['uid', 'joinRequestId', 'familyId', 'role', 'displayName', 'avatarUrl', 'rewardPoints', 'lifetimeXP', 'curre` |
| 1035 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.diff(resource.data).affectedKeys().hasOnly(['uid', 'joinRequestId', 'familyId', 'role', 'displayName', 'avatarUrl', 'rewardPoints', 'lifetimeXP', 'curre` |
| 1036 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `&& data.get('rewardPoints', -1) == 0 && data.get('lifetimeXP', -1) == 0` |
| 1036 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `&& data.get('rewardPoints', -1) == 0 && data.get('lifetimeXP', -1) == 0` |
| 1037 | `currentStreak` | read | users.currentStreak | Consecutive qualifying days | `&& data.get('currentStreak', -1) == 0 && data.get('longestStreak', -1) == 0 && data.get('lastActiveDate', 'null') == request.time;` |
| 1037 | `longestStreak` | read | users.longestStreak | Legacy best-streak counter on the user doc | `&& data.get('currentStreak', -1) == 0 && data.get('longestStreak', -1) == 0 && data.get('lastActiveDate', 'null') == request.time;` |
| 1613 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `'role', 'familyId', 'rewardPoints', 'lifetimeXP', 'walletBalance', 'balance', 'lastFundTxId',` |
| 1613 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `'role', 'familyId', 'rewardPoints', 'lifetimeXP', 'walletBalance', 'balance', 'lastFundTxId',` |
| 1799 | `behaviour_events` | calculate | families/{f}/behaviour_events | Behaviour intent log | `match /behaviour_events/{eventId} {` |
| 1951 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `allow create: if request.resource.data.type != 'financial_penalty' && familyIsActive(familyId) && ((request.resource.data.type == 'reversal' && isValidReversalW` |
| 2186 | `reversal` | read | families/{f}/reversals | Reversal / compensation path | `allow create: if (request.resource.data.type == 'reversal' && isValidReversalFundLedger(familyId, txId))` |
| 2421 | `lifetimeXP` | calculate | users.lifetimeXP | Legacy duplicate lifetime XP counter | `// - All states: client rewardPoints/lifetimeXP writes on task completion are DENIED` |
| 2421 | `rewardPoints` | calculate | users.rewardPoints | Spendable Reward Points balance (RP) | `// - All states: client rewardPoints/lifetimeXP writes on task completion are DENIED` |
| 2424 | `gamification_events` | calculate | families/{f}/gamification_events | Existing XP event ledger | `// Server-only collections: task_occurrences, gamification_events, daily_eligibility,` |
| 2424 | `task_occurrences` | calculate | families/{f}/gamification_events | Server-side task occurrence dedupe records | `// Server-only collections: task_occurrences, gamification_events, daily_eligibility,` |
| 2425 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `// daily_progress, gamification_summaries, gamification_checkpoints` |
| 2426 | `task_occurrences` | calculate | families/{f}/task_occurrences | Server-side task occurrence dedupe records | `match /task_occurrences/{occurrenceId} {` |
| 2430 | `gamification_events` | calculate | families/{f}/gamification_events | Existing XP event ledger | `match /gamification_events/{eventId} {` |
| 2444 | `gamification_summaries` | calculate | families/{f}/gamification_summaries | Legacy projection collection | `match /gamification_summaries/{summaryId} {` |
...
| Line | Term | Operation | Source | Semantic meaning | Code |
|---|---|---|---|---|---|
| 43 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `* are derived here inside a single transaction. ˋusers.lifetimeXPˋ is written` |
| 44 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `* only as a COMPATIBILITY MIRROR of ˋgamification_summaries.xpTotalˋ and must` |
| 44 | `xpTotal` | read | families/{f}/gamification_summaries | Projection lifetime XP counter (authoritative today) | `* only as a COMPATIBILITY MIRROR of ˋgamification_summaries.xpTotalˋ and must` |
| 52 | `behaviour_events` | read | families/{f}/behaviour_events | Behaviour intent log | `const eventRef = familyRef.collection('behaviour_events').doc(args.behaviourEventId)` |
| 62 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `const summaryRef = familyRef.collection('gamification_summaries').doc(childId)` |
| 73 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `const gamificationEventRef = familyRef.collection('gamification_events').doc(behaviourGamificationEventId(args.behaviourEventId))` |
| 86 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `currentRewardPoints: integer(child.rewardPoints),` |
| 87 | `xpTotal` | read | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `currentXpTotal: integer(summary?.xpTotal),` |
| 88 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `currentLifetimeXP: integer(child.lifetimeXP),` |
| 95 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `rewardPoints: plan.nextRewardPoints,` |
| 96 | `xpTotal` | calculate | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `// Compatibility-only mirror; authoritative XP is summary.xpTotal.` |
| 97 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `lifetimeXP: plan.nextLifetimeXP,` |
| 105 | `xpTotal` | read | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `xpTotal: plan.nextXpTotal,` |
...
| Line | Term | Operation | Source | Semantic meaning | Code |
|---|---|---|---|---|---|
| 422 | `bestStreak` | initialise | summary.bestStreak | Projection best-streak counter | `schemaVersion: 1, familyId, childId, xpTotal: 0, level: 1, currentStreak: 0, bestStreak: 0,` |
| 422 | `currentStreak` | initialise | users.currentStreak | Consecutive qualifying days | `schemaVersion: 1, familyId, childId, xpTotal: 0, level: 1, currentStreak: 0, bestStreak: 0,` |
| 422 | `level` | initialise | in-memory / derived | Member level | `schemaVersion: 1, familyId, childId, xpTotal: 0, level: 1, currentStreak: 0, bestStreak: 0,` |
| 422 | `xpTotal` | initialise | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `schemaVersion: 1, familyId, childId, xpTotal: 0, level: 1, currentStreak: 0, bestStreak: 0,` |
| 455 | `xpTotal` | calculate | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `const nextXp = base.xpTotal + xpDelta` |
| 461 | `currentStreak` | read | users.currentStreak | Consecutive qualifying days | `let currentStreak = base.currentStreak` |
| 464 | `currentStreak` | read | users.currentStreak | Consecutive qualifying days | `currentStreak = 0` |
| 468 | `currentStreak` | read | users.currentStreak | Consecutive qualifying days | `currentStreak = base.lastQualifiedDayKey !== null && addFamilyDays(base.lastQualifiedDayKey, 1) === progress.dayKey` |
| 469 | `currentStreak` | calculate | users.currentStreak | Consecutive qualifying days | `? base.currentStreak + 1 : 1` |
| 476 | `xpTotal` | read | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `xpTotal: nextXp,` |
| 477 | `level` | read | in-memory / derived | Member level | `level: levelForXp(nextXp, 1000),` |
| 478 | `currentStreak` | read | users.currentStreak | Consecutive qualifying days | `currentStreak,` |
| 479 | `bestStreak` | calculate | summary.bestStreak | Projection best-streak counter | `bestStreak: Math.max(base.bestStreak, currentStreak),` |
| 479 | `currentStreak` | calculate | users.currentStreak | Consecutive qualifying days | `bestStreak: Math.max(base.bestStreak, currentStreak),` |
| 602 | `task_occurrences` | read | families/{f}/task_occurrences | Server-side task occurrence dedupe records | `const occurrenceRef = familyRef.collection('task_occurrences').doc(logicalKey)` |
| 605 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `const summaryRef = familyRef.collection('gamification_summaries').doc(childId)` |
| 649 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `transaction.get(familyRef.collection('gamification_events').doc(taskXpEventId(logicalKey))),` |
| 650 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `transaction.get(familyRef.collection('gamification_events').doc(taskXpReversalEventId(logicalKey))),` |
| 652 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `.map(id => transaction.get(familyRef.collection('gamification_events').doc(id))),` |
| 684 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `const currentPoints = child.rewardPoints ?? 0` |
| 685 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `if (!Number.isSafeInteger(currentPoints) \|\| currentPoints < 0) throw new Error('Child rewardPoints is invalid')` |
| 687 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `if (!Number.isSafeInteger(nextPoints)) throw new Error('Child rewardPoints would exceed the safe integer range')` |
| 706 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `// Mirror the authoritative gamification_summaries.xpTotal into the` |
| 706 | `xpTotal` | read | families/{f}/gamification_summaries | Projection lifetime XP counter (authoritative today) | `// Mirror the authoritative gamification_summaries.xpTotal into the` |
| 707 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `// users.lifetimeXP compatibility field, in the SAME transaction, so the` |
| 709 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `const childUpdate: Record<string, unknown> = { lifetimeXP: summary.xpTotal }` |
| 709 | `xpTotal` | read | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `const childUpdate: Record<string, unknown> = { lifetimeXP: summary.xpTotal }` |
| 711 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `childUpdate.rewardPoints = nextPoints` |
| 715 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `for (const document of plan.events) transaction.create(familyRef.collection('gamification_events').doc(document.id), eventToData(document.event))` |
| 782 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `const summaryRef = familyRef.collection('gamification_summaries').doc(effect.childId)` |
| 792 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `transaction.get(familyRef.collection('gamification_events').doc(taskXpEventId(effect.logicalCompletionKey))),` |
| 793 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `transaction.get(familyRef.collection('gamification_events').doc(taskXpReversalEventId(effect.logicalCompletionKey))),` |
| 795 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `.map(id => transaction.get(familyRef.collection('gamification_events').doc(id))),` |
| 826 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `const currentPoints = child.rewardPoints ?? 0` |
| 831 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `if (!Number.isSafeInteger(nextPoints) \|\| nextPoints < 0) throw new Error('Task invalidation would make rewardPoints invalid')` |
| 832 | `rewardPoints` | write | users.rewardPoints | Spendable Reward Points balance (RP) | `transaction.update(childRef, { rewardPoints: nextPoints })` |
| 834 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `for (const document of plan.events) transaction.create(familyRef.collection('gamification_events').doc(document.id), eventToData(document.event))` |
| 877 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `const summaryRef = familyRef.collection('gamification_summaries').doc(childId)` |
| 897 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `.map(id => transaction.get(familyRef.collection('gamification_events').doc(id))))` |
| 912 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `for (const document of events) transaction.create(familyRef.collection('gamification_events').doc(document.id), eventToData(document.event))` |
| 915 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `// Mirror the authoritative gamification_summaries.xpTotal into the` |
| 915 | `xpTotal` | read | families/{f}/gamification_summaries | Projection lifetime XP counter (authoritative today) | `// Mirror the authoritative gamification_summaries.xpTotal into the` |
| 916 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `// users.lifetimeXP compatibility field, in the SAME transaction, so the` |
| 918 | `lifetimeXP` | write | users.lifetimeXP | Legacy duplicate lifetime XP counter | `transaction.update(childRef, { lifetimeXP: summary.xpTotal })` |
| 918 | `xpTotal` | write | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `transaction.update(childRef, { lifetimeXP: summary.xpTotal })` |
| 971 | `lifetimeXP` | read | users.lifetimeXP | Legacy duplicate lifetime XP counter | `const lifetimeXp = child.data().lifetimeXP` |
| 973 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `const baseline = await familyRef.collection('gamification_events').doc(ˋlegacy_xp_baseline:${encodeURIComponent(familyId)}:${encodeURIComponent(child.id)}ˋ).get` |
| 976 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `const summary = await familyRef.collection('gamification_summaries').doc(child.id).get()` |
| 1011 | `gamification_events` | read | families/{f}/gamification_events | Existing XP event ledger | `const eventQuery = this.rebuildQuery(familyRef.collection('gamification_events'), args.childId, checkpoint.watermarkAt, checkpoint.eventCursor)` |
| 1062 | `gamification_summaries` | read | families/{f}/gamification_summaries | Legacy projection collection | `const summaryRef = familyRef.collection('gamification_summaries').doc(args.childId)` |
...
| Line | Term | Operation | Source | Semantic meaning | Code |
|---|---|---|---|---|---|
| 98 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `rewardPoints: newState.rewardPoints,` |
| 99 | `xpTotal` | write | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `xpTotal: existingState.xpTotal + event.xpDelta,` |
| 100 | `weeklyPoints` | write | derived (client-computed today) | Weekly leaderboard score | `weeklyPoints: existingState.weeklyPoints + event.weeklyPointsDelta,` |
| 101 | `currentStreak` | read | users.currentStreak | Consecutive qualifying days | `currentStreak: newState.currentStreak,` |
| 102 | `bestStreak` | calculate | summary.bestStreak | Projection best-streak counter | `bestStreak: Math.max(existingState.bestStreak, newState.currentStreak),` |
| 102 | `currentStreak` | calculate | users.currentStreak | Consecutive qualifying days | `bestStreak: Math.max(existingState.bestStreak, newState.currentStreak),` |
| 107 | `xpProgressInLevel` | read | summary.xpProgressInLevel | XP accumulated inside the current level | `xpProgressInLevel: newState.xpProgressInLevel,` |
| 108 | `xpToNextLevel` | read | summary.xpToNextLevel | XP remaining until the next level | `xpToNextLevel: newState.xpToNextLevel,` |
...
| 298 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `it('task approval: rewardPoints +10, xpTotal +10, lifetimeXP +10 (same transaction)', async () => {` |
| 298 | `rewardPoints` | test | users.rewardPoints | Spendable Reward Points balance (RP) | `it('task approval: rewardPoints +10, xpTotal +10, lifetimeXP +10 (same transaction)', async () => {` |
| 298 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `it('task approval: rewardPoints +10, xpTotal +10, lifetimeXP +10 (same transaction)', async () => {` |
| 311 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[summaryPath()]).toMatchObject({ xpTotal: 10 })` |
| 312 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()]).toMatchObject({ rewardPoints: 10, lifetimeXP: 10 })` |
| 312 | `rewardPoints` | test | users.rewardPoints | Spendable Reward Points balance (RP) | `expect(db.store[childPath()]).toMatchObject({ rewardPoints: 10, lifetimeXP: 10 })` |
| 313 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `// Mirror invariant: lifetimeXP === xpTotal.` |
| 313 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `// Mirror invariant: lifetimeXP === xpTotal.` |
| 314 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()].lifetimeXP).toBe(db.store[summaryPath()].xpTotal)` |
| 314 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[childPath()].lifetimeXP).toBe(db.store[summaryPath()].xpTotal)` |
| 317 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `it('daily goal: xpTotal +25, lifetimeXP +25 (mirrored by processApprovedCompletion and finalizeChildDay)', async () => {` |
| 317 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `it('daily goal: xpTotal +25, lifetimeXP +25 (mirrored by processApprovedCompletion and finalizeChildDay)', async () => {` |
| 329 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `// Task XP (100) + daily-goal bonus (25) = 125, mirrored into lifetimeXP.` |
| 330 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[summaryPath()]).toMatchObject({ xpTotal: 125 })` |
| 331 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()]).toMatchObject({ lifetimeXP: 125 })` |
| 339 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()].lifetimeXP).toBe(db.store[summaryPath()].xpTotal)` |
| 339 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[childPath()].lifetimeXP).toBe(db.store[summaryPath()].xpTotal)` |
| 342 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `it('perfect day: xpTotal +50 (perfect-day bonus), lifetimeXP mirrored (same transaction)', async () => {` |
| 342 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `it('perfect day: xpTotal +50 (perfect-day bonus), lifetimeXP mirrored (same transaction)', async () => {` |
| 356 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[summaryPath()]).toMatchObject({ xpTotal: 175 })` |
| 357 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()]).toMatchObject({ lifetimeXP: 175 })` |
| 365 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()].lifetimeXP).toBe(db.store[summaryPath()].xpTotal)` |
| 365 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[childPath()].lifetimeXP).toBe(db.store[summaryPath()].xpTotal)` |
| 368 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `it('already-drifted user: new task +10 makes lifetimeXP = new xpTotal (430), not an increment from old lifetimeXP', async () => {` |
| 368 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `it('already-drifted user: new task +10 makes lifetimeXP = new xpTotal (430), not an increment from old lifetimeXP', async () => {` |
| 375 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `// Approve the 420-XP base task -> projection xpTotal 420, mirror 420.` |
| 382 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[summaryPath()]).toMatchObject({ xpTotal: 420 })` |
| 383 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()]).toMatchObject({ lifetimeXP: 420 })` |
| 386 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `db.store[childPath()] = { ...db.store[childPath()], lifetimeXP: 400 }` |
| 406 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `// New task +10 -> projection xpTotal 430.` |
| 407 | `xpTotal` | test | summary.xpTotal | Projection lifetime XP counter (authoritative today) | `expect(db.store[summaryPath()]).toMatchObject({ xpTotal: 430 })` |
| 409 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()].lifetimeXP).toBe(430)` |
| 410 | `lifetimeXP` | test | users.lifetimeXP | Legacy duplicate lifetime XP counter | `expect(db.store[childPath()].lifetimeXP).not.toBe(410)` |
...
| 696 | `approveTaskCompletion` | read | in-memory / derived | V4 task completion command (RP + XP credit) | `export const approveTaskCompletion = async (familyId: string, completionId: string, comment?: string) => {` |
...
| 1017 | `redeemReward` | read | in-memory / derived | Reward redemption (RP debit) | `export const redeemReward = async (` |
...
| 3127 | `rewardPoints` | read | users.rewardPoints | Spendable Reward Points balance (RP) | `const currentPoints = userData.rewardPoints \|\| 0;` |
| 3132 | `rewardPoints` | write | users.rewardPoints | Spendable Reward Points balance (RP) | `transaction.update(userRef, { rewardPoints: currentPoints - cost });` |
