...
export function OnboardingVisual({ title, children, caption, className = '' }: OnboardingVisualProps) {
  return (
    <div
      ...
      aria-label={title}
      className={[
        'relative flex aspect-[16/9] w-full max-w-md items-center justify-center overflow-hidden rounded-[2rem] sm:aspect-[4/3]',
    ...
    >
      ...
      <div className="relative flex h-full w-full items-center justify-center p-2 sm:p-6">{children}</div>
