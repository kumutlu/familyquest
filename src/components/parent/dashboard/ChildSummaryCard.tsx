        ...
        <CardContent className="p-4 sm:p-5">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs font-medium text-gray-500">Level {level}</p>
            </div>
          </div>

          <div className="mt-4 grid grid-cols-3 gap-2 text-center">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Points</p>
          ...
          <p className="mt-3 text-sm font-semibold text-primary-600">View Profile &rarr;</p>
        </CardContent>
      </Card>
    </Link>
  );
